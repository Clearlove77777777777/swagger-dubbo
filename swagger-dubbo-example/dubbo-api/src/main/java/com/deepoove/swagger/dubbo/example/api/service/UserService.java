...
public interface UserService {
	...
	@ApiOperation(nickname = "byPhone", value = "查询用户byPhone", notes = "通过phone取用户信息", response = User.class, responseContainer = "List")
	List<User> query(@ApiParam(value = "用户phone") String phone);

	@ApiOperation(nickname = "byArea", value = "查询用户byArea", notes = "通过城市地区code取用户信息", response = User.class, responseContainer = "List")
	...
	User update(@ApiParam(value = "用户信息") User user, String operator);
